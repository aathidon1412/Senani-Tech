  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        isScrolled
          ? "py-3 shadow-card bg-white/95 border-b border-default"
          : "bg-transparent py-5",
      )}
    >
      <div className="container mx-auto px-4">
        <nav className="relative flex items-center justify-between">
          ...
          <Link
            to="/"
            className="relative group inline-flex items-center gap-0"
          >
            <motion.div
            ...
            <div className="flex flex-col items-end mr-2">
              <div className="flex flex-col bg-white/5 border border-default/40 rounded-md px-3 py-1 shadow-sm">
                ...
                >
                  ...
                  <span className="leading-tight">info@senanitech.com</span>
                </a>
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              transition={{ duration: 0.2 }}
              className="xl:hidden fixed inset-0 z-40 bg-white/95 backdrop-blur-sm overflow-auto"
            >
